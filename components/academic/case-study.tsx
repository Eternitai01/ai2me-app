                ...
                <div className="container max-w-7xl mx-auto px-4 md:px-4 lg:px-6">
                    <div className="content text-white max-w-lg relative z-10">
                        ...
                        <h2 className="text-[32px] md:text-[48px] font-bold mb-4 text-pretty">
                            University Cut Research AI Costs by 32%
                        </h2>
                        <p className="text-base font-light mb-5">
                            A global university adopted AI2me to process large-scale medical and genomic datasets. By leveraging multi-model routing, they reduced infrastructure costs by 32% and accelerated research cycles—while maintaining GDPR and SOC 2 compliance.
                        </p>
                        <div className="py-3 px-5 bg-[#0033AF] font-base rounded-md font-normal mb-6">
                            <p>“32% lower AI costs with faster research outcomes.”</p>
                        </div>
                        <div className="mt-4">
