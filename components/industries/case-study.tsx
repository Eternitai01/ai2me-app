                ...
                <div className="container max-w-7xl mx-auto px-4 md:px-4 lg:px-6">
                    <div className="content text-white max-w-lg relative z-10">
                        ...
                        <h2 className="text-[32px] md:text-[48px] font-bold mb-4">
                            Fintech Reduced Fraud Losses by 35%
                        </h2>
                        <p className="text-base font-light mb-5">
                            A leading digital bank integrated AI2me for real-time fraud monitoring. False positives dropped by 22% and fraud-related losses reduced by 35% all while maintaining GDPR & SOC 2 compliance.
                        </p>
                        <div className="py-3 px-5 bg-[#0033AF] font-base rounded-md font-normal mb-6">
                            <p>“22% fewer false positives with AI2me.”</p>
                        </div>
                        <div className="mt-4">
