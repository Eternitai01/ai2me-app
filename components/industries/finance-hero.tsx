...
export  function FinanceHeroSection() {
  ...
  return (
    <section className="relative py-12 lg:py-32 !pt-105 md:!pt-35 lg:!pt-60 overflow-hidden bg-[#F7F8F9] herobanner">
        ...
        <div className="flex justify-start items-center gap-12">
          <div className="text-start max-w-[100%] md:max-w-[50%]">
            ...
            >
              Secure, compliant, and cost-efficient AI solutions built for banks, fintechs, and financial institutions. Prevent fraud, streamline compliance, and deliver smarter customer experiences—while meeting the strictest regulatory standards.
            </p>
