    ...
    <section className="w-full flex justify-center  pb-12 md:pb-10 pt-10 md:pt-10 relative">
      ...
      backgroundRepeat: "no-repeat",
        ...
        <h2 className="text-[32px] md:text-[48px] font-bold text-white mb-5 leading-[42px] md:leading-[62px]">
          Ready to Transform  <br className="hidden md:block" /> Banking with Smarter AI
        </h2> 

        <p className="text-white/80 max-w-2xl mx-auto mb-8 text-base font-normal md:text-lg">
          AI2me helps banks and financial institutions cut costs, reduce fraud, and stay complaints with a strict regulations- all through a single secure AI gateway.
        </p>

        <Link href={"/"}><button className="bg-white cursor-pointer text-black font-medium py-3 px-6 rounded-full shadow-md hover:shadow-lg transition">
          Get Started
        </button></Link>
      </div>
      </div>
