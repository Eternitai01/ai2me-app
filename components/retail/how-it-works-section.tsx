...
import {  ShieldCheck, ChartBarBig, Wallet2, Zap } from "lucide-react"
  ...
  const steps = [
    {
      icon: ChartBarBig,
      title: "Scalability",
      description: "Handles seasonal shopping spikes",
    },
    {
      icon: Wallet2,
      title: "Cost Optimization",
      description: "Smart routing for AI compute savings",
    },
    {
      icon: ShieldCheck,
      title: "Security & Compliance",
      description: "PCI DSS, GDPR-ready infrastructure",
    },
    
    {
      icon: Zap,
      title: "Faster Deployment",
      description: "Plug-and-play APIs",
    },
  ]
