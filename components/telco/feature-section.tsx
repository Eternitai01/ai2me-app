...
import {  ShieldAlert, Globe, Coins, MessageCircleHeart } from "lucide-react";
      ...
      <div className="container max-w-7xl mx-auto px-4 md:px-4 lg:px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-40 items-center">
          <div>
            ...
            <h2 className="text-[32px] md:text-[48px] font-bold mb-4">Driving Growth for Telecom Providers</h2>
            <p className="text-gray-600 mb-8">
              AI2me reduces risks, optimizes costs, and enhances customer experiences for telecom companies.
            </p>
              ...
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <div className="text-base text-gray-600">
                    Minimize fraud and outages with AI-driven monitoring.
                  </div>
                </div>
              </li>
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <div className="text-base text-gray-600">
                    Optimize AI usage and vendor costs across networks.
                  </div>
                </div>
              </li>
              <li className="flex items-start">
                <span className="mt-1 mr-3 text-[#0033AF]"><MessageCircleHeart size={22}/></span>
                <div>
                  <span className="font-semibold text-lg">Customer Experience</span>
                  <div className="text-base text-gray-600">
                    Deliver personalized, AI-powered engagement.
                  </div>
                </div>
              </li>
               <li className="flex items-start">
                ...
                <div>
                  ...
                  <div className="text-base text-gray-600">
                    Support global-scale telecom infrastructure.
                  </div>
                </div>
              </li>
            </ul>
          ...
          <div className="relative flex justify-end md:justify-center">
            ...
            <Image
              src="/images/InnovationTelcom.png"
              height={592}
              width={600}
            ...
            />
            <Image
              src="/images/InnovationTelcomTop.png"
              height={197}
              width={204}
